...
global preInterruptHandle
global preInterruptHandleOffset
...
preInterruptHandle:
  ...
  .end:
    ...
    jle .then1
    push dword 0    ;<8 =15 >17
    jmp .then0
    .then1:
        cmp dword [interruptNumber], 10
        jge .then0
        push dword 0    ;=8 10<= $ <=14 =17
    .then0:
...
[SECTION .data]
    preInterruptHandleOffset DD (preInterruptHandle.entry1 - preInterruptHandle.entry0)
